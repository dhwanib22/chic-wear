...
class Generate_Fit_Detail extends StatelessWidget {
  final assetPath, fitname;

  Generate_Fit_Detail({this.assetPath, this.fitname});
  @override
      ...
      body: ListView(children: [
        ...
        Center(
          child: Container(
            ...
            child: Text(
                "Let's get you dressed! Just hit the generate outfit button and get a chic fit to get you dressed for today",
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontFamily: 'Varela',
                    fontSize: 16.0,
